...
class TestG2Invariance:
    ...
    The two exposed generators close to the Frobenius group F21 = Z7 ⋊ Z3
    (order 21), a finite subgroup of the exceptional Lie group G2. Testing
    both generators plus their composition covers a non-trivially generated
    group element.
    """
    ...
    def test_composed_automorphism_preserves_associator_norm(
        ...
        individual generators, covering a product element of the order-21
        Frobenius group F21 generated by cycle_7 and quad_res.
        """
